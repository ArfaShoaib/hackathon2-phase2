...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Attempt to sign up using custom auth API
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="glass-card w-full max-w-md p-8 space-y-8">
        <div className="text-center">
          ...
          <h2 className="mt-2 text-xl font-semibold text-[hsl(0,0%,98.5%)]">Create Account</h2>
          <p className="mt-2 text-[hsl(0,0%,72%)]">Join our premium task management experience</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center">
            ...
            />
            <label htmlFor="terms" className="ml-2 block text-sm text-[hsl(0,0%,72%)]">
              I agree to the <a href="#" className="text-[hsl(190,92%,65%)] hover:underline">Terms</a> and <a href="#" className="text-[hsl(190,92%,65%)] hover:underline">Privacy Policy</a>
            </label>
          </div>
        ...
        <div className="text-center text-sm text-[hsl(0,0%,72%)]">
          ...
          <Link href="/login" className="text-[hsl(190,92%,65%)] hover:underline font-medium">
            Sign in
          </Link>
        </div>
      </div>
